...
public class Exercici0 {
    ...
    public static boolean validarData(String data) {
        ...
        try {
            int any = Integer.parseInt(div[0]);
    ...
    public static String generaClauClient() {
        ...
        HashMap<String, Boolean> clientsExistents = new HashMap<>();
        ...
        } while (clientsExistents.containsKey(clau)); 
    
        clientsExistents.put(clau, true);
